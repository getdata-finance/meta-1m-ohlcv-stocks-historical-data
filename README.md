...
> **Sample on GitHub** · `META_1m.csv` (55,440 rows, `2026-02-06` -> `2026-09-01`, 5.48 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/meta)** — **637,227** `1m` rows (full `1m`: 637,227), **11 timeframes**, `2020-02-25` -> `2026-09-01`.
