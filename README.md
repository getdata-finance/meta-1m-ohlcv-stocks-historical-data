...
> **Sample on GitHub** · `META_1m.csv` (55,440 rows, `2026-02-06` -> `2026-09-01`, 5.48 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/meta)** — **637,227** `1m` rows, **11 timeframes**, `2020-02-25` -> `2026-09-01`.
...
df = pd.read_csv('META_1m.csv', parse_dates=['time'])
...
The complete **META** archive on **[getdata.finance](https://getdata.finance/datasets/meta)** includes **11 OHLCV timeframes** (1m · 3m · 5m · 15m · 30m · 1H · 4H · 12H · 1D · 3D · 1W) — **637,227** rows at `1m`, plus all other timeframes in the same ZIP.
